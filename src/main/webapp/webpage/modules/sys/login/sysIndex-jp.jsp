...
<nav class="navbar navbar-inverse display-default opnav-navbar navbar-fixed-top" role="navigation">
	<div class="topnav-navbar">
		<div class="navbar-header text-center">
			...
			<a class="navbar-brand J_menuItem" href="${ctx}/home" data-index="0">档案管理系统</a>
		</div>
	</div>
	<div class="navbar-container container-fluid">
		<div class="collapse navbar-collapse navbar-collapse-toolbar row" id="jpMenu">
			<ul id="o1" class="nav navbar-toolbar nav-tabs  navbar-left" style="width: calc( 100% - 620px)" role="tablist">
...
<section id="body-container" class="animation">
	...
	<div class="footer">
		<div class="pull-left"><a href="http://www.epipe.cn">优管网</a> &copy; 2015-2025</div>
	</div>

	...
	<script type="text/javascript">
        function save() {
            ...
            if(!isValidate){
                ...
                jp.loading();
                jp.post("${ctx}/sys/companyDict/save",$('#inputForm').serialize(),function(data){
                    if(data.success){
...
<body class="bg-white">
	<form:form id="inputForm" modelAttribute="dictType" action="${ctx}/sys/companyDict/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		       ...
		       <tr>
		         ...
		         <td class="width-35" >
					 <form:select path="type"  class="form-control m-b">
						 ...
						 <form:options items="${fns:getDictList('company_dict_type')}" itemLabel="label" itemValue="value" htmlEscape="false"/>
					 </form:select>
				 </td>
		      </tr>
		       <tr>

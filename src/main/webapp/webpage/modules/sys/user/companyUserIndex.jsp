				...
				<div class="accordion-inner">
					<form id="searchForm" class="form form-horizontal well clearfix" >
						...
						<div class="col-sm-4">
					    	...
					    	<sys:treeselect id="company" name="company.id" value="${user.company.id}" labelValue="${user.company.name}"
										title="公司" url="/sys/office/treeData?type=1&isAll=false" cssClass=" form-control" allowClear="true"/>
					    </div>
					    <div class="col-sm-4">
					    	<label class="label-item single-overflow pull-left" title="员工：">归属部门：</label>
					   		<sys:treeselect id="office" name="office.id" value="${user.office.id}" labelValue="${user.office.name}"
								title="部门" url="/sys/office/treeData?type=2&isAll=false" cssClass=" form-control" allowClear="true" notAllowSelectParent="true"/>
					    </div>
					    <div class="col-sm-4">

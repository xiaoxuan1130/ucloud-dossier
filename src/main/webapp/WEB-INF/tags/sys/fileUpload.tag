...
<%@ attribute name="target" type="java.lang.String" required="false" description="上传目标"%>
...
<%@ attribute name="deniedExtensions" type="java.lang.String"  required="false" description="不允许的文件类型"%>
...
<script type="text/javascript">
    function ${path}FileDialogOpen() {
        ...
        jp.open({
            ...
            title:"上传文件",
            auto:true,
            content: "${ctx}/tag/fileUpload?fileValues="+encodeURIComponent(currentFileValues)+"&uploadPath=${uploadPath}"+"&type=${type}"+"&readonly=${readonly}&target=${target}"

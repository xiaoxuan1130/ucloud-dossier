...
public class QRCodeUtils {
    ...
    public static void creatRrCode(String appUrl,String contents, int width, int height, HttpServletResponse response) {
        appUrl=appUrl+"qrcode/user/login";
        JSONObject object=new JSONObject();
        object.put("url",appUrl);
        object.put("uuid",contents);
        object.put("source","2");
        object.put("type","1");
        contents=object.toJSONString();

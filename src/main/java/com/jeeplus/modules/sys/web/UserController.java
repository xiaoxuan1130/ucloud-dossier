...
public class UserController extends BaseController {
	...
	public String companyIndex(User user, Model model) {
		model.addAttribute("user",UserUtils.getUser());
		return "modules/sys/user/companyUserIndex";
	}
...
//	@RequiresPermissions("sys:user:index")
	@ResponseBody
	@RequestMapping(value = {"no_permission_list", ""})
	public Map<String, Object> listWithoutPermission(User user, HttpServletRequest request, HttpServletResponse response, Model model) {
	...
	public String form(User user, Model model) {
		...
		for (Role role : roleList){
			role.setName(StringUtils.substringBeforeLast(role.getName(), "_"));
			role.setEnname(StringUtils.substringBeforeLast(role.getEnname(), "_"));
		}
	...
	public AjaxJson save(User user, HttpServletRequest request, Model model) {
		...
		boolean contains = systemService.containsEmployee(user.getRoleList());
		if (!contains) {
			Role defaultRole = systemService.getRoleByEnname("employee");
...
//				currentUser.setPhoto(user.getPhoto());
	...
	public String selectUserToRole(String officeId,Model model) {
		...
		return "modules/sys/user/tagUserSelect";
	}

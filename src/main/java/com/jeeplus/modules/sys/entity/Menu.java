...
public class Menu extends DataEntity<Menu> {
	...
	/** 菜单类型 */
	private List<MenuType> menuTypeList = Lists.newArrayList();
	...
	public List<String> getMenuTypeCodeList() {
		List<String> menuTypeCodeList = Lists.newArrayList();
		for (MenuType menuType : menuTypeList){
			menuTypeCodeList.add(menuType.getMenuTypeCode());
		}
		return menuTypeCodeList;
	}

	public void setMenuTypeCodeList(List<String> menuTypeCodeList) {
		menuTypeList = Lists.newArrayList();
		for (String menuTypeCode : menuTypeCodeList){
			MenuType menuType = new MenuType();
			menuType.setMenuTypeCode(menuTypeCode);
			menuType.setMenuId(id);

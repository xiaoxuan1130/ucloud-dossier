  ...
  */    
    public boolean sendTextMail(MailBody mailInfo) throws Exception{    
      ...
      // 如果需要身份认证，则创建一个密码验证器    
        ...
        //new PasswordAuthentication(mailInfo.getMailServerHost(),"yuugexywbkevbfdd");
      }   
...
public static void main(String[]agrs){
	    MailSendUtils.sendEmail("smtp.qq.com","","1024046894@qq.com",
                "yuugexywbkevbfdd","1024046894@qq.com","test","liugf","1");
}

...
//
//		String start = "2019-03-22 11:28:35";
//		String end = "2019-03-25 11:28:35";
//
//		System.out.println(daysInterval(parseDate(start), parseDate(end)));
		String str=getDate("yyyyMMddhhmmss");

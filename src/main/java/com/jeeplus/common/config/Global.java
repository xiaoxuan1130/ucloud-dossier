...
public class Global {
	 ...
	 * 属性文件加载对象
	 */
	private static PropertiesLoader loader = new PropertiesLoader("/properties/epipe.properties");
	...
	public static final String DEFAULT_COMPANY_NAME="crm默认公司";
...
//		System.out.println("userfiles.basedir: " + dir);
	...
	public static void modifyConfig(String key, String value) {
		try {
			...
			String path = Global.class.getResource("/properties/epipe.properties").getPath();
	...
	public static Properties getProperties(){
		...
		try {
			Reader reader = Resources.getResourceAsReader("/properties/epipe.properties");
			prop.load(reader);
		} catch (Exception e) {
			return null;
		}
